...
public class KnifeParserTest {
    private final String[] ID = {"1", "2", "3", "4"};
    private final String[] TYPE = {"Knife", "Saber", "Dagger", "Machete"};
    private final Integer[] HANDY = {1, 2, 1, 1};
    private final String[] ORIGIN = {"India", "German", "USA", "Brazil"};
    private final Integer[] LENGTH = {10, 60, 21, 70};
    private final Integer[] WIDTH = {21, 5, 10, 30};
    private final String[] MATERIAL = {"Steel", "Steel", "Steel", "Steel"};
    private final String[] HANDLE = {"Indian banyan", "Metal", "Carbone", "Rubber"};
